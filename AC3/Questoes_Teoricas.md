## Diferença entre translação, rotação e escala
...
## Por que rotações em eixos diferentes produzem resultados distintos?
...
## Quando Python é melhor que a transformação manual?
